    ...
    <div className="app-shell">
      ...
      <main className="page-content narrow profile-page">
        ...
        <section className="profile-identity">
          {profileImage ? (
            <img className="profile-avatar profile-avatar-image" src={profileImage} alt="Profile" />
          ) : (
          ...
          <div className="profile-avatar-actions">
            ...
            {profileImage && (
              <button type="button" className="btn-ghost danger" onClick={() => setProfileImage("")}>Remove</button>
            )}
          </div>
        </section>
